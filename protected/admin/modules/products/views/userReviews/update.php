...
<section class="content-header" style="margin-bottom: .5em">
        <h1>
                UserReviews        <small>Update</small>
        </h1>
        <ol class="breadcrumb">
                <li><a href="<?php echo Yii::app()->request->baseurl . '/site/home'; ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                <li class="active">Update UserReviews</li>
        </ol>
</section>
&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo Yii::app()->request->baseurl . '/admin.php/products/userReviews/admin'; ?>" class='btn  btn-laksyah manage'>Manage Buyer</a>
